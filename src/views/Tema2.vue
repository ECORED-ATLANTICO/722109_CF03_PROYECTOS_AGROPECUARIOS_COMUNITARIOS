  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center.justify-content-center.mb-4
      .col-lg-7.mb-3(data-aos="fade-left").order-2.order-lg-1
        p.mb-5.mb-lg-3 Al mismo tiempo la decisión de la ubicación del proyecto está relacionada con aspectos financieros, económicos y sociales que pueden tener repercusiones en el desarrollo económico y social de una región en el largo plazo.
    ...
    .row.align-items-center.justify-content-center.mb-2
      ...
      .col-lg-5.mb-3(data-aos="fade-right")
        img.mt-3.mx-auto.img-responsive(src='@/assets/curso/tema2/img_22.png'  alt='')
    ...
    .row.align-items-center.justify-content-center.mb-4.mb-lg-5
      ...
      .col-md-12.col-lg-10.mb-3(data-aos="zoom-in-down")
        .tarjeta.bg-98.p-2
          .row.justify-content-around.align-items-center
            .col-md-3
              img(src="@/assets/curso/tema2/img_13.png")
            .col-md-9
      ...
      .col-md-12.col-lg-10.mb-3(data-aos="zoom-in-down")
        .tarjeta.bg-04.p-2
          .row.justify-content-around.align-items-center
            .col-md-3
              img(src="@/assets/curso/tema2/img_14.png")
            .col-md-9
      ...
      .col-md-12.col-lg-10.mb-3(data-aos="zoom-in-down")
        .tarjeta.bg-98.p-2
          .row.justify-content-around.align-items-center
            .col-md-3
              img(src="@/assets/curso/tema2/img_15.png")
            .col-md-9
      ...
      .col-md-12.col-lg-10.mb-3(data-aos="zoom-in-down")
        .tarjeta.bg-04.p-2
          .row.justify-content-around.align-items-center
            .col-md-3
              img(src="@/assets/curso/tema2/img_16.png")
            .col-md-9
