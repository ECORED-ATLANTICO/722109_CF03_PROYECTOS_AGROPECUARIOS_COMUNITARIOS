...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-2
      .col-lg-12.mb-5
        .bloque-texto-g.bloque-texto-g--inverso.bg-98.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
    ...
    .row.align-items-center.justify-content-star.mb-1.ps-2(data-aos="zoom-in-down")
      ...
      .align-items-center.justify-content-star.mb-2
        .div(data-aos="fade-left")
          h3.subtitle.position-relative Sector
    ...
    .tarjeta.tarjeta.bg-05.p-4.slyder_1.img_fondo_3
      SlyderA(tipo="b").tarjeta--blanca(style="border-radius: 20px")
        .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-5
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/img_20.png', alt='Texto que describa la imagen')
        ...
        .row.justify-content-center.align-items-center.my-lg-4.p-5
          ...
          .col-md-8
            figure
              img(src='@/assets/curso/tema1/img_21.png', alt='Texto que describa la imagen')
        .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-8.mb-4.mb-md-0
            h4 Presentación
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/img_22.png', alt='Texto que describa la imagen')
        .row.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-4.mb-4.mb-md-0
          ...
          .col-md-8
            figure
              img(src='@/assets/curso/tema1/img_23.png', alt='Texto que describa la imagen')
        .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-8.mb-4.mb-md-0
            h4 Composición
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/img_24.png', alt='Texto que describa la imagen')
        .row.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-4.mb-4.mb-md-0
            h4 Producto
          ...
          .col-md-8
            figure
              img(src='@/assets/curso/tema1/img_25.png', alt='Texto que describa la imagen')
        .row.ordenar_tarjeta.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-8.mb-4.mb-md-0
            h4 Sustitutos
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/img_26.png', alt='Texto que describa la imagen')
        .row.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-4.mb-4.mb-md-0
            h4 Precios y costos
          ...
          .col-md-8
            figure
              img(src='@/assets/curso/tema1/img_27.png', alt='Texto que describa la imagen')
        .row.justify-content-center.align-items-center.my-lg-4.p-5
          .col-md-8.mb-4.mb-md-0
          ...
          .col-md-4
            figure
              img(src='@/assets/curso/tema1/img_28.png', alt='Texto que describa la imagen')
    Separador
    ...
    .row.align-items-center.justify-content-center.mb-2
      ...
      .col-lg-7.mb-3(data-aos="fade-left") 
        ...
        .cajon.bg-04.p-4.ps-5.bg_18.mb-4.mb-lg-0
          .row
            .col-md-3
              img.mt-1.w-auto.mx-auto.mb-2(src='@/assets/curso/tema1/img_30.svg'  alt='')
            .col-md-9
    ...
    .row.justify-content-center.align-items-center.mb-2
      .col-lg-12.mb-5
        .bloque-texto-g.bloque-texto-g--inverso.bg-98.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/img_31.png')})`}"
          )
          .bloque-texto-g__texto.p-4
    ...
    .row.justify-content-center.align-items-center.mb-2
      .col-lg-12.mb-5
        .bloque-texto-g.bloque-texto-g.bg-98.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/tema1/img_51.png')})`}"
          )
          .bloque-texto-g__texto.p-4
    ...
    .row.justify-content-center.align-items-center.mb-2.ordenar_tarjeta
      ...
      .col-md-4.mb-4 
        img.mx-auto.img-responsive(src='@/assets/curso/tema1/img_52.png'  alt='')
    Separador  
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-md-12.col-lg-10.mb-5
        ...
        figure
          img.d-none.d-lg-block.d-md-block(src='@/assets/curso/tema1/img_76.svg', alt='La figura describe una matriz de posicionamiento basada en la relación entre calidad y precio. El eje vertical representa la calidad, desde baja en la parte inferior hasta alta en la parte superior. El eje horizontal representa el precio, desde alto en el lado izquierdo hasta bajo en el lado derecho. La matriz se divide en cuatro cuadrantes: Premium, correspondiente a productos de alta calidad y precio alto; Adecuada relación precio/calidad, correspondiente a productos de alta calidad y precio bajo o competitivo; No competitiva, correspondiente a productos de baja calidad y precio alto; y Económica, correspondiente a productos de baja calidad y precio bajo. Esta clasificación permite identificar el posicionamiento de productos o servicios según la percepción de calidad y el nivel de precio.')
          img.d-block.d-sm-block.d-lg-none.d-md-none(src='@/assets/curso/tema1/img_77.svg', alt='La figura describe una matriz de posicionamiento basada en la relación entre calidad y precio. El eje vertical representa la calidad, desde baja en la parte inferior hasta alta en la parte superior. El eje horizontal representa el precio, desde alto en el lado izquierdo hasta bajo en el lado derecho. La matriz se divide en cuatro cuadrantes: Premium, correspondiente a productos de alta calidad y precio alto; Adecuada relación precio/calidad, correspondiente a productos de alta calidad y precio bajo o competitivo; No competitiva, correspondiente a productos de baja calidad y precio alto; y Económica, correspondiente a productos de baja calidad y precio bajo. Esta clasificación permite identificar el posicionamiento de productos o servicios según la percepción de calidad y el nivel de precio.')
